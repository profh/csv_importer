class Importer
  ...
  def import_csv_data_as_students
    ...
    # now we return an array of student objects generated from each row 
    # of csv file; can later iterate through and save them if desired.
    return students
  end
  ...
  def read_data(data)
    # this is the key method where we map data columns to attributes
    @last_name = data[0]
    @first_name = data[1]
    @email = data[2]
    # if you want visual confirmation during the process...
